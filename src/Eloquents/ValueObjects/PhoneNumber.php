...
class PhoneNumber
{
    ...
    */
    ...
    private static function extractCountryCode(string $phone_number): int
    {
        ...
        throw new \LaravelCoreModule\CoreModuleMaker\Exceptions\InvalidArgumentException('Error while formatting phone number country code');
    }
    ...
    private static function validatePhoneNumber(int $phoneNumber): bool
    {
        ...
        if (!preg_match('/^\d{8,11}$/', (string) $phoneNumber)) {
            throw new \LaravelCoreModule\CoreModuleMaker\Exceptions\InvalidArgumentException('Invalid phone number');
        }
    ...
    private static function validateCountryCode(int $countryCode): bool
    {
        ...
        if (!preg_match('/^[1-9]\d{0,2}$/', (string) $countryCode)) {
            throw new \LaravelCoreModule\CoreModuleMaker\Exceptions\InvalidArgumentException('Invalid country code');
        }
    ...
    private static function validateAreaCode(?int $areaCode): bool
    {
        ...
        if (!preg_match('/^\d{2,3}$/', $areaCodeString)) {
            throw new \LaravelCoreModule\CoreModuleMaker\Exceptions\InvalidArgumentException('Invalid area code');
        }
